...
describe UsersController do
  ...
  describe "GET 'new'" do
    ...
    #Testing for each field on the signup form
  ...
  #Tests for the user edit action
  describe "GET 'edit'" do
   before(:each) do
     @user = Factory(:user)
     #to sign in as the user in anticipation of protecting the edit page from unauthorized access
     test_sign_in(@user)
   end
...
#Authentication for editing and updating pages
  describe "authentication of edit/update pages" do
    before(:each) do
      @user = Factory(:user)
    end
    #Only signin users can have access to edit and update actions
    describe "for non-signed-in users" do
    ...
    #only the signin user can edit or update is own profile. He can't edit or update other user profile.
    describe "for signed-in users" do
      before(:each) do
  ...
  #Tests for destroying users - check that not only admins can delete users, but also that other ysers can't.
  ...
  #Test for the following and followers actions
